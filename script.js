const dataset = [
  ...
  },
  {
    ...
    "Year": 2004,
    "Nationality": "POR",
    "Doping": "Implicated in the Operaci&oacute;n Puerto doping case",
    "URL": "https://en.wikipedia.org/wiki/Operaci%C3%B3n_Puerto_doping_case"
  },
  {
    "Time": "39:15",
...
const w = 250 * zoomFactor;
const h = 100 * zoomFactor;
const padding = 50;
...
const xScale = d3.scaleTime()
                 .domain([d3.min(dataset, (d) => parseYear(d.Year - 1)), d3.max(dataset, (d) => parseYear(d.Year + 1))])
...
svg.selectAll("circle")
       ...
       .attr("r", 7)
       .attr("fill", (d, i) => (d.Doping === '' ? 'white' : 'black'))
       .attr("class", "dot")
       ...
       .on("mouseover", function(d) {       
            div.transition()        
                .duration(200)      
                .style("opacity", 0.95);   
            div .attr("data-year", d3.select(this).attr("data-xvalue"))
                .attr("data-time", d3.select(this).attr("data-yvalue"))   
                .html(d.Name + ", " + d.Nationality + "<br/>" +
                      "Year: " + d.Year + ", Time: " + d.Time +
                      (d.Doping === '' ? '' : "<div class='doping'>" + d.Doping + "</div>"))
